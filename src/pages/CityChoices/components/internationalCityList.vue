	...
	<div class="">
		<div class="city-lists" >
			...
			<ul class="city-hot-list">
				<li class="city-hot-list-item" v-for="item in InternationalHotCityList" :key=item.id>
...
<script>
	...
	export default {
		...
		computed:mapState({
			InternationalHotCityList:(state) => (
				state.cityChoices.InternationalHotCityList
				),
